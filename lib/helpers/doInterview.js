...
function handleQueuedItem(dequeuedObject, taskFinished) {
  ...
  models.Channel.findOne({
    ...
    if (channel) {
      var userRealName;
      var thumbUrl;
      var pastBlockers, yesterdayTodo = '';
      ...
      models.Standup.findAll({
        ...
        if (standups.length > 0) {
          ...
          yesterdayTodo += 'Last time, you said that you would:\n> ';
          yesterdayTodo += standups[standups.length-1].today + ' \n';
        ...
        bot.startPrivateConversation({user: interviewUser}, function(response, convo){
          ...
          interviewSetup.then(function() {
            ...
            const sections = [
              {
                question: '${yesterdayTodo} What did you do yesterday? ',
                name: 'yesterday'
              },
              {
